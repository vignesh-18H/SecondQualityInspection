		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapdmcsecondquality-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdmcsecondquality-display": {
								"semanticObject": "comsapdmcsecondquality",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.dmc.secondquality",
									"url": sap.ui.require.toUrl("com/sap/dmc/secondquality")
								}
							}
						}
					}
